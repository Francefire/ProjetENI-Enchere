// Cette classe permet de gérer la connexion avec la base de données via le context.xml et une éventuelle
// data source qui n'est ici pas paramétrée dans ce TP. 
